...
const questionBar = document.getElementsByClassName('question-bar');
...
function initQuiz() {
  ...
  Array.from(questionBar).forEach((bar) => (bar.style.visibility = 'visible'));
...
submitButton.onclick = () => {
  ...
  Array.from(questionBar).forEach((bar) => (bar.style.visibility = 'hidden'));
